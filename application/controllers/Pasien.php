...
class Pasien extends CI_Controller {
	...
	public function index() {
		$data['data'] = $this->pasienmodel->get_data_pasien();
		$this->load->view('pasien/pasien',$data);
	}

	public function search() {
		$keyword = $this->input->post('keyword');
		$data = $this->pasienmodel->get_data_pasien($keyword);
		$data = array(
			'keyword'	=> $keyword,
			'data'		=> $data
		);
	...
	public function insertPasien() {
		...
		$this->pasienmodel->insert_pasien($data, 'pasiens');
	...
	public function insertPenerbit() {
		...
		$this->pasienmodel->insertPenerbit($data, 'penerbit');
		redirect(base_url('admin'));
	}
	public function edit($a)
    {
        $data['detail_pasien'] = $this->pasienmodel->get_detail_pasien($a);
    ...
    public function update($id_pasien)
    {
        ...
        if ($this->pasienmodel->update_pasien($this->input->post(), $id)) {
