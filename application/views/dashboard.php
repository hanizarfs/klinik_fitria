			...
			<nav class="nav">
				<div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">BBBootstrap</span> </a>
					<div class="nav_list">
						...
						<a href="<?php echo base_url('tindakan') ?>" class="nav_link"> <i class='bx bx-message-square-detail nav_icon'></i>
							<span class="nav_name">Tindakan</span>
						</a>
						<a href="<?php echo base_url('about') ?>" class="nav_link"> <i class='bx bx-bookmark nav_icon'></i>
							<span class="nav_name">Obat</span>
						</a>
						<a href="<?php echo base_url('rawat') ?>" class="nav_link"> <i class='bx bx-folder nav_icon'></i>
