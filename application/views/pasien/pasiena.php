		...
		<nav class="nav">
			<div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span
				...
				<div class="nav_list">
					...
					<a href="<?php echo base_url('obat') ?>" class="nav_link"> <i class='bx bx-bookmark nav_icon'></i>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a href="pasien/delete/<?php echo $row['id_pasien'];?>" type="button" class="btn btn-primary">Save
						changes</a>
				</div>
			</div>
		</div>
